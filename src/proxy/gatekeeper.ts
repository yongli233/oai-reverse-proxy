...
<<<<<<< HEAD
          error: {
            message: `Forbidden: No more IPs can authenticate with this token!`,
          },
=======
...
<<<<<<< HEAD
          return res
            .status(403)
            .json({ error: { message: `Forbidden: ${reason}` } });
=======
...
<<<<<<< HEAD
  res.status(401).json({ error: { message: config.unauthorizedMessage } });
=======
